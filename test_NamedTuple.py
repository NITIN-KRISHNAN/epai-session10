...
def test_namedtuple_avg_age():
    ...
    assert round(NamedTuple.calculate_avg_age(profile_list)[0],2) == round(20.747433264887064,2)
...
def test_namedtuple_oldest_age():
    ...
    assert round(NamedTuple.calculate_oldest_person_age(profile_list)[0],2) == round(20.747433264887064,2)
